...
@Component({
  selector: 'app-emissao-dap',
  templateUrl: './emissao-dap.component.html',
  styleUrls: ['./emissao-dap.component.css']
})
export class EmissaoDapComponent implements OnInit {
  ...
  TEMPLATE_TITLE: string = 'Emissão de Dap';
  TEMPLATE_SUB: string = 'Registros Declaração de aptidão ao PRONAF';
  ...
  ngOnInit(): void {
    ...
    let servico01: Chamada = {
      ...
      servicoPrestado: 'Emissão de declaração de aptidão ao PRONAF',
      valor: 0
    }
    ...
    let servico02: Chamada = {
      ...
      servicoPrestado: 'Levantamento de informações sociais e produtivas para emissão de DAP.',
      valor: 0
    }
